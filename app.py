...
BOT_RESPONSES = {
    ...
    "what is bank": "A bank is a financial institution licensed to receive deposits and make loans. Banks may also provide financial services such as wealth management, currency exchange, and safe deposit boxes.",
    ...
    "what is checking account": "A checking account is a bank account designed for frequent transactions like bill payments and purchases, usually with little or no interest.",
    "what is savings account": "A savings account is meant for storing money and earning interest, with limited withdrawals per month.",
    ...
    "what is atm": "An ATM (Automated Teller Machine) is an electronic banking outlet that allows customers to complete basic transactions without the aid of a teller, such as cash withdrawals, deposits, and transfers - available 24/7!",
    "what is online banking": "Online banking lets you manage your money through your bank's website or mobile app - check balances, transfer funds, pay bills, and more from anywhere!",
    ...
    "what is loan": "A loan is money borrowed from a lender that must be repaid with interest over a set period. Common types include personal loans, auto loans, mortgages, and student loans.",
    ...
    "what is interest": "Interest is the percentage charged by a lender for borrowing money, or paid to you for keeping money in an account. It's the cost of borrowing or the reward for saving.",
    ...
    "what is credit score range": "Credit scores typically range from 300 to 850, with higher scores indicating better creditworthiness.",
    ...
    "what is mortgage": "A mortgage is a loan used to purchase real estate, where the property itself serves as collateral. Mortgages typically have terms of 15-30 years and can have fixed or adjustable interest rates.",
    ...
    "what is personal loan": "A personal loan is an unsecured loan that can be used for various purposes like debt consolidation, home improvements, or major purchases. They typically have fixed interest rates and set repayment terms.",
    ...
    "what is auto loan": "An auto loan is a secured loan used to purchase a vehicle, where the car serves as collateral. Terms usually range from 36-72 months.",
    ...
    "what is credit card": "A credit card is a payment card that allows you to borrow funds up to a certain limit to pay for goods and services. You must repay the borrowed amount, plus any interest, according to the card's terms.",
    ...
    "what is minimum payment on credit card": "The minimum payment is the smallest amount you must pay each month to keep your credit card account in good standing. Paying only the minimum will result in interest charges and take longer to pay off the balance.",
    ...
    "what is investment": "Investing is the act of allocating resources (usually money) with the expectation of generating income or profit. Common investments include stocks, bonds, mutual funds, ETFs, real estate, and commodities.",
    ...
    "what are stocks": "Stocks represent ownership in a company and may provide dividends and capital appreciation.",
    "what are bonds": "Bonds are debt instruments where you lend money to an issuer (government or corporation) in exchange for periodic interest payments and return of principal.",
    ...
    "what is dividend": "A dividend is a distribution of a portion of a company's earnings to its shareholders, usually paid quarterly. Not all stocks pay dividends.",
    ...
    "what is index fund": "An index fund is a type of mutual fund or ETF designed to track the performance of a specific market index (like the S&P 500). They offer broad market exposure with low fees.",
    ...
    "what is budget": "Budgeting is creating a plan for how you'll spend your money each month. It helps you track income vs expenses, identify savings opportunities, and work toward financial goals.",
    ...
    "what is emergency savings": "An emergency fund is money set aside to cover unexpected expenses like medical bills, car repairs, or job loss. Financial experts typically recommend saving 3-6 months of living expenses.",
    ...
    "what are types of insurance": "Common types include: Health insurance, Life insurance, Auto insurance, Homeowners/renters insurance, Disability insurance, and Long-term care insurance.",
